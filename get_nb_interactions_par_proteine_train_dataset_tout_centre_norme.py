...
train_datasets_filename = clf_dirname + pattern_name + \
    '_kronSVM_list_train_datasets_20200609.data'
...
final_nb_interactions.to_csv("nombre_interactions_par_proteine_train_dataset_tout_centre_norme_20200609.csv")
...
plt.savefig('dist_true_interactions_par_proteine_train_dataset_tout_centre_norme_20200609.png')
plt.close()

false_dist = sns.distplot(final_nb_interactions['Nb_false_interactions'], )
plt.savefig('dist_false_interactions_par_proteine_train_dataset_tout_centre_norme_20200609.png')
plt.close()