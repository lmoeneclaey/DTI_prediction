...
#         List of all the "positive" interactions in a 'Couples' class and \
#         all the "false" interactions, also in a 'Couples' class. 
#     positive_inter : Couples
#         List of all the "positive" interactions in the train dataset
#     negative_inter : Couples
...
def make_K_train(train_dataset, DB, kernels):
    """ 
    ...
    list_couples = train_dataset.list_couples 
