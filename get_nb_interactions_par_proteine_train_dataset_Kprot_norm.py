...
train_datasets_filename = clf_dirname + pattern_name + \
    '_kronSVM_list_train_datasets_20200707.data'
list_train_datasets = pickle.load(open(train_datasets_filename, 'rb'))

print(list_train_datasets[0][14650:14655])
print(list_train_datasets[1][14650:14655])
print(list_train_datasets[2][14650:14655])
print(list_train_datasets[3][14650:14655])
print(list_train_datasets[4][14650:14655])
...
# final_nb_interactions.to_csv("nombre_interactions_par_proteine_train_dataset_Kprot_norm_20200707.csv")
...
# plt.savefig('dist_true_interactions_par_proteine_train_dataset_Kprot_norm_20200707.png')
# plt.close()

# false_dist = sns.distplot(final_nb_interactions['Nb_false_interactions'], )
# plt.savefig('dist_false_interactions_par_proteine_train_dataset_Kprot_norm_20200707.png')
# plt.close()