...
final_nb_interactions = pd.read_csv('nombre_interactions_par_proteine_train_dataset_Kprot_norm_20200707.csv', encoding='utf-8')

# 1 - VMO

process_name = "vertex-modulators-orphan"
...
# B - Kprot normé - 2020/07/07

pred_dirname = root + data_dir + 'predictions/20200707/'

ivacaftor_predictions = pd.read_csv(pred_dirname + pattern_name + '_kronSVM_norm_' + 'DB08820' + '_pred_clean_20200707.csv', encoding='utf-8')
tezacaftor_predictions = pd.read_csv(pred_dirname + pattern_name + '_kronSVM_norm_' + 'DB11712' + '_pred_clean_20200707.csv', encoding='utf-8')
lumacaftor_predictions = pd.read_csv(pred_dirname + pattern_name + '_kronSVM_norm_' + 'DB09280' + '_pred_clean_20200707.csv', encoding='utf-8')
elexacaftor_predictions = pd.read_csv(pred_dirname + pattern_name + '_kronSVM_norm_' + 'DB15444' + '_pred_clean_20200707.csv', encoding='utf-8')
...
plt.savefig('top_50_nb_interactions_per_protein_predicted_for_ivacaftor_Kprot_norm_20200707.png', dpi = 300)
plt.close()
...
plt.savefig('nb_ligands_per_protein_predicted_for_ivacaftor_Kprot_norm_20200707.png', dpi = 300)
plt.close()
...
plt.xticks(rotation=90)
plt.savefig('top_50_nb_interactions_per_protein_predicted_for_lumacaftor_Kprot_norm_20200707.png', dpi = 300)
plt.close()
...
plt.savefig('nb_ligands_per_protein_predicted_for_lumacaftor_Kprot_norm_20200707.png', dpi = 300)
plt.close()
...
# plt.savefig(nb_ligands_kernel_dir + 'nb_ligands_per_protein_predicted_for_tezacaftor_kernels_Kprot_norm_20200707.png')
# plt.close()
...
# plt.savefig(nb_ligands_kernel_dir + 'nb_ligands_per_protein_predicted_for_elexacaftor_kernels_Kprot_norm_20200707.png')
# plt.close()