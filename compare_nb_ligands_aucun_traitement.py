...
# A - aucun traitement - 2020/06/19

pred_dirname = root + data_dir + 'predictions/20200619/'

ivacaftor_predictions = pd.read_csv(pred_dirname + pattern_name + '_kronSVM_' + 'DB08820' + '_pred_clean_20200619.csv', encoding='utf-8')
tezacaftor_predictions = pd.read_csv(pred_dirname + pattern_name + '_kronSVM_' + 'DB11712' + '_pred_clean_20200619.csv', encoding='utf-8')
lumacaftor_predictions = pd.read_csv(pred_dirname + pattern_name + '_kronSVM_' + 'DB09280' + '_pred_clean_20200619.csv', encoding='utf-8')
elexacaftor_predictions = pd.read_csv(pred_dirname + pattern_name + '_kronSVM_' + 'DB15444' + '_pred_clean_20200619.csv', encoding='utf-8')
...
# plt.savefig('top_50_nb_interactions_per_protein_predicted_for_ivacaftor_kernels_non_traites_20200619.png', dpi = 300)
# plt.close()
...
# plt.savefig('nb_ligands_per_protein_predicted_for_ivacaftor_kernels_non_traites_20200619.png', dpi = 300)
# plt.close()
...
plt.xticks(rotation=90)
plt.savefig('top_50_nb_interactions_per_protein_predicted_for_lumacaftor_kernels_non_traites_20200619.png', dpi = 300)
plt.close()
...
plt.savefig('nb_ligands_per_protein_predicted_for_lumacaftor_kernels_non_traites_20200619.png', dpi = 300)
plt.close()
...
# plt.savefig('nb_ligands_per_protein_predicted_for_tezacaftor_kernels_non_traites_20200619.png')
# plt.close()
...
# plt.savefig('nb_ligands_per_protein_predicted_for_elexacaftor_kernels_non_traites_20200619.png')
# plt.close()
