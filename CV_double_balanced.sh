...
#SBATCH --output=/mnt/data4/mnajm/CFTR_PROJECT/log/double_balanced_20201023.log
#SBATCH --error=/mnt/data4/mnajm/CFTR_PROJECT/log/double_balanced_20201023.err
#SBATCH --mem 20000
...
python cross_validation/kronSVM/nested_cv_kronSVM_pred.py drugbank_v5.1.5 S0h --balanced_on_proteins --balanced_on_drugs