...
#SBATCH --output=/mnt/data4/mnajm/CFTR_PROJECT/log/VST_kronSVM_pred_20201015.log
#SBATCH --error=/mnt/data4/mnajm/CFTR_PROJECT/log/VST_kronSVM_pred_20201015.err
#SBATCH --mem 20000
